            ...
            <div class="admin-form theme-primary">
                ...
                <div class="panel-body bg-light"> 
                    ...
                    <div class="row">
                    	...
                    	<p class="text-primary mn" style="font-size: 16px;font-weight:bold;padding-bottom:10px;padding-top:10px">@lang('traduccion1.sub1vision') :</p>

                    	<p>
                    	  @lang('traduccion1.sub2vision')    
