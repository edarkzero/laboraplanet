        ...
        <div class="admin-form theme-info mw700" style="margin-top: 3%;" id="login1">
          ...
          <div class="row mb15 table-layout">
            ...
            <div class="col-xs-6 va-m pln">
              <a href="{{ route('index') }}" title="Regresar al Inicio">
                <img src="assets/img/logos/LogoLabora.png" title="Regresar al Inicio" class="img-responsive w250">
              </a>
            </div>
...
<div class="col-md-6 col-lg-3"></div>
              ...
              <div class="section row mn">
                <div class="col-sm-4">
                  <a href="{{ route('social.auth','facebook') }}" class="button btn-social facebook span-right mr5 btn-block">
                    <span>
                      <i class="fa fa-facebook"></i>
                    </span>@lang('traduccion1.sub3register')</a>
                </div>
                <div class="col-sm-4">
                  <a href="<?php  echo $linkedin->getAuthUrl() ?>" class="button btn-social twitter span-right mr5 btn-block">
                    <span>
                      <i class="fa fa-linkedin"></i>
                    </span>@lang('traduccion1.sub4register')</a>
                </div>
                <div class="col-sm-4">
                  <a href="{{ route('social.auth','google') }}" class="button btn-social googleplus span-right btn-block">
                    <span>
                      <i class="fa fa-google-plus"></i>
                    </span>@lang('traduccion1.sub5register')</a>
                </div>
              </div>
            </div>
              ...
              <div class="panel-body p25 bg-light">
                <div class="section-divider mt10 mb40">
                  <span>@lang('traduccion1.sub6register'), <a href="{{route('login')}}">@lang('traduccion1.sub7register')</a></span>
                </div>
                <!-- .section-divider -->
                ...
                <div class="section">
                  <label for="email" class="field prepend-icon">
                    ...
                    <input type="hidden" name="flag" id="flag" class="gui-input" value="1">  
