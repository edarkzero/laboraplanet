...
<a style="color: rgb(255, 255, 255); text-decoration: none;" href="{{ route('confirmation', $demo->token ) }}" target="_blank" style="font-family: 'Arial';">Click aqui, para confirmar tu correo</a></span></td></tr></tbody> 
