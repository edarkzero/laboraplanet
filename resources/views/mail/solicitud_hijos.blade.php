...
<table name="bmeMainColumn" class="bmeHolder bmeMainColumn" style="max-width: 600px; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;" cellspacing="0" cellpadding="0" border="0" align="center"><tbody><tr><td width="100%" class="blk_container bmeHolder" name="bmePreHeader" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(0, 174, 84);" bgcolor="#00ae54"></td></tr>   <tr><td width="100%" class="bmeHolder" valign="top" align="center" name="bmeMainContentParent" style="border: 0px none rgb(102, 102, 102); border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;">
<table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"><tbody><tr><td width="100%" class="blk_container bmeHolder" name="bmeHeader" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(0, 174, 84);" bgcolor="#00ae54"><div id="dv_1" class="blk_wrapper" style="">
...
</td></tr> <tr><td width="100%" class="blk_container bmeHolder bmeBody" name="bmeBody" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: #EBEBEB;" bgcolor="#ffffff"><div id="dv_15" class="blk_wrapper" style="">
...
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top" align="left">
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 150%; text-align: left;"><center><span style="font-size: 16px; font-family: 'Arial'; color: #464646; line-height: 150%;text-align: center;"><strong> <i><u>Solicitud de beneficios para personas con niños menores de 11 años</u></i> </strong></span></center>

<br/>

<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;"><b>DATOS DE USUARIO</b></span>
<br/><br/>
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;"><b>Nombre de Usuario:</b> {{ $demo->nombre }}</span>
<br/>
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;"><b>Correo de Usuario:</b> {{ $demo->correo }} </span>
<br/>
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;"><b>Numero de Hijos:</b> {{ $demo->nhijos }} </span>
<br/>
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;"><b>Telefono Usuario:</b> {{ $demo->telefono }} </span>
<br/><br/>
<table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;"><tbody><tr><td style="border-radius: 0px; border: 3px solid rgb(31, 200, 153); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;background-color: rgb(31, 200, 153);" class="bmeButtonText"><span style="font-family: 'Arial'; font-size: 14px; color: rgb(66, 66, 66);">
<a style="color: rgb(255, 255, 255); text-decoration: none;" href="{{ route('confirmation4', $demo->tok ) }}" target="_blank" style="font-family: 'Arial';">Aprobar</a></span></td></tr></tbody>
</table>
<br/>
<table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;"><tbody><tr><td style="border-radius: 0px; border: 3px solid rgb(31, 200, 153); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;background-color: rgb(31, 200, 153);" class="bmeButtonText"><span style="font-family: 'Arial'; font-size: 14px; color: rgb(66, 66, 66);">
<a style="color: rgb(255, 255, 255); text-decoration: none;" href="{{ route('confirmation5',$demo->tok) }}" target="_blank" style="font-family: 'Arial';">Desaprobar</a></span></td></tr></tbody>
</table>
</div></td></tr></tbody>
</table></td></tr>
</tbody>
...
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_button" style=""><tbody><tr><td width="20"></td><td align="left">
<table class="tblContainer" cellspacing="0" cellpadding="0" border="0" width="100%"><tbody><tr><td height="15"></td></tr><tr><td align="left">
...
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top" align="center">
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
<div style="line-height: 100%;">
<br><span style="font-size: 11px; font-family: 'Arial'; color: #464646; line-height: 200%;">Gracias,</span>
<br><span style="font-size: 11px; font-family: 'Arial'; color: #464646; line-height: 200%;">El equipo de apoyo social de LaboraPlanet</span>
<br><span style="font-size: 11px; font-family: 'Arial'; color: #464646; line-height: 200%;"></span>
<br/><br/>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="bmeHolder1" style="float:left;" align="left"><tbody><tr><td valign="top" align="center" class="blk_container bmeLeftColumn" name="bmeLeftColumn"><div id="dv_4" class="blk_wrapper" style="">
</div>
</td></tr></tbody>
