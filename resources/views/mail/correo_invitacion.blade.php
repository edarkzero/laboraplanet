...
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 150%;">
	...
	<center><span style="font-size: 25px; font-family: 'Arial'; color: #464646; line-height: 150%;text-align: center;" ><strong><i><u>Invitacion a LaboraPlanet</u></i></strong></span></center>
<br/>
<span style="font-size: 15px;font-family: 'Arial'; color: #464646; line-height: 150%;">Hola 	@if(isset($demo->nombre_amigo))
	{{ strtoupper($demo->nombre_amigo) }}!
	@endif  !</span><br/><br/>

<span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;">{{ strtoupper($demo->userActual) }} , nuestro usuario de la plataforma LABORAPLANET te invita a formar parte de esta gran familia.
</span><br/><br/>

<span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;">LABORAPLANET es una plataforma interactiva, intuitiva y segura que te ofrece la oportunidad laboral  como Freelancer en muchos requerimientos y los puedes desarrollar  conectado desde cualquier parte del mundo…  </span><br/><br/>


<br/>
<center><span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;text-align: center;">Click aquí: &emsp;<u style="font-size: 16px">https://www.laboraplanet.com</u></span></center>   
...
<br><span style="font-size: 12px; font-family: 'Arial'; color: #464646; line-height: 200%;">Bienvenido(a),</span>
