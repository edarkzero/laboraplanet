...
<em><strong>¡ HAY USUARIOS INTERESADOS EN TU REQUERIMIENTO !</strong></em></span></td></tr></tbody>    
</table></td></tr></tbody>    
...
<span style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #929292; line-height: 150%;">Hola <strong> {{ $demo->nombreusupro }},</strong> el usuario {{$demo->enviaruwu}}  ha aplicado a tu proyecto <strong> "{{$demo->nombreproyectousu}}" </strong>, para ver mas detalles click en el boton de abajo.</span>    
...
<a style="color:#FFFFFF;text-decoration:none;" target="_blank" href="{{route('aspirantes',$demo->idproyectousu)}}" >Ver Postulantes</a></span></td></tr></tbody>    
