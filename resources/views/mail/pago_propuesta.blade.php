...
table[name="bmeMainBody"], body {background-color:rgba(47,47,47,0.3);}    
 td[name="bmePreHeader"] {background-color:#ADA7A6;}    
 td[name="bmeHeader"] {background:#ADA7A6;background-color:#ADA7A6;}    
 td[name="bmeBody"], table[name="bmeBody"] {background-color:#ADA7A6;}    
 td[name="bmePreFooter"] {background-color:#ADA7A6;}    
 td[name="bmeFooter"] {background-color:#ADA7A6;}    
 ...
 [name=bmeMainContentParent] {border-color:#ADA7A6;border-width:0px;border-style:none;border-radius:0px;border-collapse:separate;border-spacing:0px;overflow:hidden;}    
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" name="bmeMainBody" style="" ><tbody><tr><td width="100%" valign="top" align="center">    
...
<table name="bmeMainColumn" class="bmeHolder bmeMainColumn" style="max-width: 600px; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;" cellspacing="0" cellpadding="0" border="0" align="center"><tbody><tr><td width="100%" class="blk_container bmeHolder" name="bmePreHeader" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(0, 174, 84);" bgcolor="#ADA7A6"></td></tr>   <tr><td width="100%" class="bmeHolder" valign="top" align="center" name="bmeMainContentParent" style="border: 0px none rgb(102, 102, 102); border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;">    
<table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center"><tbody><tr><td width="100%" class="blk_container bmeHolder" name="bmeHeader" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(0, 174, 84);" bgcolor="#ADA7A6"><div id="dv_1" class="blk_wrapper" style="">    
...
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color: rgb(31, 200, 153);" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 15px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 150%; text-align: right;"><span style="font-size: 12px; font-family: 'Courier New', Courier; color: #ADA7A6; line-height: 150%;"><span style="text-decoration: underline; line-height: 150%;" >
    <img src="https://www.laboraplanet.com/img/LogoLabora.png" class="mobile-img-large" width="100%" style="max-width: 1120px; display: block; width: 300px;" alt="" border="0"></span></span></div></td></tr></tbody> 
    <!-- AQUI ESTA LA IMAGEN DEL LOGO DE LABORAPLANET -->   
</table></td></tr></tbody>    
</table></td></tr></tbody>    
</table></div>
</td></tr> <tr><td width="100%" class="blk_container bmeHolder bmeBody" name="bmeBody" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: #EBEBEB;" bgcolor="#ADA7A6"><div id="dv_15" class="blk_wrapper" style="">    
...
</div><div id="dv_17" class="blk_wrapper" style="">    
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>    
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top">    
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 150%;">
	...
	<center><span style="font-size: 25px; font-family: 'Arial'; color: #464646; line-height: 150%;text-align: center;" ><strong><i><u>Informacion de Pago</u></i></strong></span></center>
<br/>
<span style="font-size: 15px;font-family: 'Arial'; color: #464646; line-height: 150%;">Has realizado el deposito para {{ $demo2->usuapli[0]['nombres']." ".$demo2->usuapli[0]['apellidos'] }}, en el requerimiento {{ $demo2->proyectoc[0]['titulo'] }}.</span><br/><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> N° de Pedido # : {{ $demo2->numpedido }}
</span></center><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> N° de Autorizacion : {{ $demo2->numautori }}
</span></center><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> Nombre del Comprador : {{ $demo2->comprador }}
</span></center><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> N° de Tarjeta : {{ $demo2->numtarje }}
</span></center><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> Fecha y Hora del Pedido : {{ $demo2->fechayhoralleva }}
</span></center><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> Importe de la Transaccion : {{ $demo2->importe }}
</span></center><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> Moneda de la Transaccion : {{ $demo2->moneda }}
</span></center><br/>

<center><span style="font-size: 15px; font-family: 'Arial'; color: #464646; line-height: 150%;"> Comentarios : {{ $demo2->comentarios }}
</span></center><br/>
...
<br/>
<center><a href="{{route('aspirantes',$demo2->idpro)}}" target="_blank" style="font-size: 16px">Click aqui, ir al requerimiento</a></center>   
...
</td></tr><tr><td height="15"></td></tr></tbody>    
</table></td><td width="20"></td></tr></tbody>    
</table></div><div id="dv_6" class="blk_wrapper" style="">    
</div><div id="dv_8" class="blk_wrapper" style="">    
</div><div id="dv_20" class="blk_wrapper" style="">    
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>    
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top" align="center">    
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 10px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 200%;"><span style="font-size: 10px; font-family: 'Arial'; color: #464646; line-height: 200%;"></span>      
<br><span style="font-size: 12px; font-family: 'Arial'; color: #464646; line-height: 200%;">Estimados,</span>
<br><span style="font-size: 12px; font-family: 'Arial'; color: #464646; line-height: 200%;">LaboraPlanet</span>
<br/><br/>
<center><span style="font-size: 10px; font-family: 'Arial'; color: #464646; line-height: 200%;">--- Se agradece no responder a este buzón ya que es un buzón desatendido. ---</span></center>
</div></td></tr></tbody>    
</table></td></tr></tbody>    
</table></td></tr></tbody>    
</table></div>
...
<table class="bmeHolder" name="bmeBody" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(255, 255, 255);" bgcolor="#ADA7A6"> <tbody><tr> <td width="100%" valign="top" align="center">   <div>    
...
</table> </td></tr> <tr><td width="100%" class="blk_container bmeHolder" name="bmePreFooter" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(255, 255, 255);" bgcolor="#ADA7A6"><div id="dv_5" class="blk_wrapper" style="">    
</div><div id="dv_9" class="blk_wrapper" style="">    
</div><div id="dv_12" class="blk_wrapper" style="">    
</div><div id="dv_7" class="blk_wrapper" style="">    
</div>
...
<a href="https://benchmarkemail.benchurl.com/c/l?u=5EE6FDB&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1" target=_blank  style="display: inline-block;background-color: rgba(0, 0, 0, 0);border-radius: 28px;border-style: solid; border-width: 2px; border-color: rgb(255, 255, 255);" target="_blank"><!-- <img    
...
<a href="https://benchmarkemail.benchurl.com/c/l?u=5EE6FDD&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1" target=_blank  style="display: inline-block;background-color: rgba(0, 0, 0, 0);border-radius: 28px;border-style: solid; border-width: 2px; border-color: rgb(255, 255, 255);" target="_blank"><!-- <img    
...
<a href="mailto:" style="display: inline-block;background-color: rgba(0, 0, 0, 0);border-radius: 28px;border-style: solid; border-width: 2px; border-color: rgb(255, 255, 255);" target="_blank"><!-- <img    
...
</table></td> </tr>  <tr><td width="100%" class="blk_container bmeHolder" name="bmeFooter" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(255, 255, 255);" bgcolor="#ADA7A6"><div id="dv_3" class="blk_wrapper">    
</div>
</td></tr> </tbody>    
</table> </td></tr></tbody>    
</table></td></tr></tbody>    
 ...
 src='https://benchmarkemail.benchurl.com/c/o?e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&relid=' alt='' border=0 style="display:none;" height=1 width=1>        
