...
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>    
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top" align="center">    
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 150%; text-align: left;"><span style="font-size: 16px; font-family: 'Arial'; color: #464646; line-height: 150%;"><strong>Bienvenido a bordo {{ $demo->nombres }}.</strong></span>
<br/>
<br/>
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;">¡Felicitaciones por unirse a LaboraPlanet!.<br/> Este es el primero de muchos pasos en su viaje hacia la construcción, administracion de trabajos y requerimientos.</span>
<br/>
<br/>
<!--<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;">Todo lo que necesita hacer ahora es verificar su dirección de correo electrónico e inmediatamente puede comenzar a publicar y comenzar a trabajar.</span>-->
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;">La seguridad es primordial para nosotros, Por favor confirma tu correo.</span>
</div></td></tr></tbody>    
</table></td></tr></tbody>    
</table></td></tr></tbody>    
...
<a style="color: rgb(255, 255, 255); text-decoration: none;" href="{{ route('confirmation2', $demo->token ) }}" target="_blank" style="font-family: 'Arial';">Click aqui, para confirmar tu correo</a></span></td></tr></tbody> 
...
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>    
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top" align="center">    
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 200%;"><span style="font-size: 11px; font-family: 'Arial'; color: #464646; line-height: 200%;">Si no creó una cuenta, no se requiere ninguna acción adicional.</span>      
