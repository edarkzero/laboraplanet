...
<table width="100%" cellspacing="0" cellpadding="0" border="0" name="bmeMainBody" style="background-color:#35736E;" bgcolor="#000000"><tbody><tr><td width="100%" valign="top" align="center">    
...
<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td align="center" class="bmeImage" style="border-collapse: collapse;"><span style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #d63c3c; line-height: 150%;">    
<em><strong>¡ TU PROPUESTA HA SIDO ACEPTADA !</strong></em></span></td></tr></tbody>    
</table></td></tr></tbody>    
...
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_card" align="center"><tbody><tr><td class="bmeImageCard" align="center" style="padding-left:20px; padding-right:20px; padding-top:0px; padding-bottom:0px;">    
<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center"><tbody><tr><td valign="top" class="bmeImageContainer" style="border-collapse: collapse; background-color: rgba(0, 0, 0, 0);" width="560">    
<table cellspacing="0" cellpadding="0" border="0" width="100%"><tbody><tr><td valign="top" align="center" class="tdPart">    
<table cellspacing="0" cellpadding="0" border="0" class="bmeCaptionTable"  width="373" align="center"><tbody><tr><td style="padding: 20px 0px 20px 20px; font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 14px; color: rgb(56, 56, 56);" name="tblCell" valign="top" align="center" class="tblCell"><div style="line-height: 150%;">    
 
<span style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #929292; line-height: 150%;"><strong>Felicidades has sido contratado por {{ Auth::user()->nombres." ".Auth::user()->apellidos}} en el requerimiento "{{ strtoupper($demo->proyectoc[0]['titulo']) }}" por el monto de $ {{$demo->precio}}, realizar tu trabajo con puntualidad y profesionalismo te permitirá subir de nivel en la plataforma y aumentar tus clientes.</strong>
</table></td></tr></tbody>    
</table></td></tr></tbody>    
</table></td></tr></tbody>    
</table>
...
<table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;"><tbody><tr align="center"><td align="center" style="border-radius: 20px; border: 0px none transparent; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 10px 40px; font-weight: bold; background-color: rgb(214, 60, 60); " align="center" class="bmeButtonText"><span style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(255, 255, 255);">    
<a style="color:#FFFFFF;text-decoration:none;" target="_blank" href="{{ route('index') }}">Ver Detalles</a></span></td></tr></tbody>    
...
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 200%;">Gracias por trabajar con nosotros.</span>
<br/><br/>
...
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 200%;">© 2018 Todos los Derechos Reservados | LaboraPlanet</span>  
