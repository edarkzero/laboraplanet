...
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 150%; text-align: left;"><center><span style="font-size: 16px; font-family: 'Arial'; color: #464646; line-height: 150%;text-align: center;"><strong> <i><u>Correo de Solicitud de Informacion</u></i> </strong></span></center>
<br/>
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;">Ha recibido este correo porque un usuario esta solicitando informacion sobre un proyecto o requerimiento</span>
<br/><br/>
<span>Estos son los datos:</span>
<br/><br/>
<span>Nombres y Apellidos: {{ $demo->nombres }} {{ $demo->apellidos }} </span>
<br/>
<span>Correo electronico: {{ $demo->correo }}</span>
<br/>
<span>Nacionalidad: {{ $demo->pais }}</span>
<br/>
<span>WhatsApp: {{ $demo->numero }}</span>
<br/>
<span>Detalle del requirimiento: {{ $demo->detalle }}</span>
...
<table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;"><tbody><tr></tr></tbody> 
</table>
...
<br><span style="font-size: 11px; font-family: 'Arial'; color: #464646; line-height: 200%;">Soporte LaboraPlanet</span>
