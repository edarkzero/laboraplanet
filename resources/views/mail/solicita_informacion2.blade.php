...
<br/>
<span style="font-size: 13px; font-family: 'Arial'; color: #464646; line-height: 150%;">Ha recibido este correo porque un usuario esta intentando comunicarse con LaboraPlanet.</span>
<br/><br/>
<span>Estos son los datos:</span>
<br/><br/>
<span>Nombres y Apellidos: {{ $demo->nombre }}</span>
<br/>
<span>Correo electronico: {{ $demo->email }}</span>
<br/>
<span>Asunto : {{ $demo->asunto }}</span>
<br/>
<span>Mensaje: {{ $demo->mensaje }}</span>
