...
<a style="color: rgb(255, 255, 255); text-decoration: none;" href="{{ route('confirmation', $token ) }}" target="_blank"  style="font-family: 'Arial';" id="{{ $token }}">Confirmar Correo</a></span></td></tr></tbody> 
...
<table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_text"><tbody><tr><td>    
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow"><tbody><tr><td class="tdPart" valign="top" align="center">    
<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText"><tbody><tr><td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 10px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell"><div style="line-height: 200%;"><span style="font-size: 10px; font-family: 'Arial'; color: #464646; line-height: 200%;">Si no solicito esta cambio, no se requiere ninguna acción adicional.</span>      
<br><span style="font-size: 10px; font-family: 'Arial'; color: #464646; line-height: 200%;">Saludos,</span>
<br><span style="font-size: 10px; font-family: 'Arial'; color: #464646; line-height: 200%;">LaboraPlanet</span>
<br/><br/>
