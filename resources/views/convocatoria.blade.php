...
<!--                 <a href="{{ route('social.auth','google') }}" class="button btn-social googleplus span-left btn-block">
              ...
              <div class="panel-body p25 bg-light">
                <div class="section-divider mt10 mb40">
                  <span>@lang('traduccion2.txtcreatucuentaconv') <a href="{{route('login')}}">@lang('traduccion2.txtcreatucuentaconv2')</a></span>
                </div>
                <!-- .section-divider -->
                ...
                <div class="section">
                  <label for="email" class="field prepend-icon">
                      ...
                      <input type="hidden" name="flag" id="flag" class="gui-input" value="0">
