      ...
      <header id="topbar" class="alt">
      	<div class="topbar-left">
            ...
            <li class="crumb-active">
              <a href="javascript:void(0);">@lang('traduccion1.sub1recibo_pago_error')</a>
            </li>
          </ol>
      	</div>
                ...
                <div class="panel panel-success heading-border">
                  <div class="panel-heading">
                    <span class="panel-title">
                      <i class="fa fa-shopping-cart"></i> @lang('traduccion1.sub2recibo_pago_error') </span>
                  </div>
                  ...
                  <form method="post" action="/" id="form-order3">
                    <div class="panel-body p25">
                    	<div class="row">
                    		...
                    		<div class="section">
                        		<label class="field option">
                          			<em class="small-text text-muted">@lang('traduccion1.sub3recibo_pago_error'):</em>
                        		</label>
                      		</div>
                    		</div>
                    		<div class="col-md-3">
                    	...
                    	<div class="row">
                    		...
                    		<div class="section">
                        		<label class="field option">
                          			<em class="small-text text-muted">N° de Tarjeta:</em>
                        		</label>
                      		</div>
                    		</div>
                    		<div class="col-md-3">
                    	...
                    	<div class="row">
                    		...
                    		<div class="section">
                        		<label class="field option">
                          			<em class="small-text text-muted">Fecha y Hora:</em>
                        		</label>
                      		</div>
                    		</div>
                        <?php
                    	...
                    	<div class="row">
                    		...
                    		<div class="section">
                        		<label class="field option">
                          			<em class="small-text text-muted">@lang('traduccion1.sub6recibo_pago_error'):</em>
                        		</label>
                      		</div>
                    		</div>
                    		<div class="col-md-3">
                    ...
                    <div class="panel-footer">
                    	<div class="row">
                    		<div class="col-md-3"></div>
                    		<div class="col-md-3">
                    			<a href="imprimir_recibo_error/{{ $numpedido }}/{{ $numtarje }}/{{ $fechayhoralleva }}/{{ $comentarios }}" target="_blank" id="imprimir"  class="btn btn-rounded btn-default btn-block">@lang('traduccion1.sub7recibo_pago_error')</a>
                    		</div>
                    		<div class="col-md-3">
                    			<a href="pago/{{ $_GET['cod'] }}/{{ $_GET['pro'] }}" type="button" class="btn btn-rounded btn-success btn-block">@lang('traduccion1.sub8recibo_pago_error')</a>
                    		</div>
                    		<div class="col-md-3"></div>
                    	</div>
