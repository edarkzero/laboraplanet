            ...
            <div class="media "  v-for="value in lista" v-if="(value.usuario).toUpperCase().indexOf(contacto.toUpperCase().trim())>=0">
              ...
              <div class="media-body" style="width: 85%">
                <h5 class="media-heading">
                  <a v-if="value.id!=380" :href="urls+`/verperfil/`+value.id"> {{ value.usuario }} &nbsp; </a>
                  <a v-else href="javascript:void(0);" v-on:click="mostrar(value.id,imagen(value.imagen),value.nombres+' '+value.apellidos,value.perfil,value.precio_hora,value.usuario,value.rol)"> {{ value.usuario }} &nbsp; </a>
